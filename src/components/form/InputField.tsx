    ...
    <div className=" mt-3 w-[100%]">
      ...
      <div className="relative mt-1 rounded-md ">
        ...
        <input
          ...
          className="w-full py-3 pr-7 pl-8 block rounded-md border border-gray-300 outline-offset-1 outline-transparent focus:border-blue-500 focus:ring-blue-700 focus:ring-1 text-sm"
